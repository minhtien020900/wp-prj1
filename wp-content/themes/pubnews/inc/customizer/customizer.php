 ...
 */
function pubnews_customize_register( $wp_customize ) {
	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
    $wp_customize->get_section( 'background_image' )->title = esc_html__( 'Background', 'pubnews' );
    $wp_customize->get_section( 'colors' )->title = esc_html__( 'Presets Colors', 'pubnews' );
    $wp_customize->get_section( 'colors' )->panel = 'pubnews_colors_panel';
     ...
     * @since 1.0.0
     */
    $wp_customize->add_panel( 'pubnews_colors_panel', array(
        'title' => esc_html__( 'Colors', 'pubnews' ),
        'priority'  => 7
    ));
    ...
    // color group control
    class Pubnews_WP_Color_Group_Control extends Pubnews_WP_Base_Control {
        // control type
        public $type = 'color-group';
    }

    // color image group control
    class Pubnews_WP_Color_Image_Group_Control extends Pubnews_WP_Base_Control {
        // control type
        public $type = 'color-image-group';
    }

    // color picker control
    class Pubnews_WP_Color_Picker_Control extends Pubnews_WP_Base_Control {
        // control type
        public $type = 'color-picker';
    }

    // preset color picker control
    class Pubnews_WP_Preset_Color_Picker_Control extends Pubnews_WP_Base_Control {
        // control type
        public $type = 'preset-color-picker';
        public $variable = '--pubnews-global-preset-theme-color';
    ...
    class Pubnews_WP_Responsive_Range_Control extends Pubnews_WP_Base_Control {
        // control type
    ...
    // toggle control 
    class Pubnews_WP_Toggle_Control extends Pubnews_WP_Base_Control {
        // control type
    ...
    // checkbox control 
    class Pubnews_WP_Checkbox_Control extends Pubnews_WP_Base_Control {
        // control type
    ...
    class Pubnews_WP_Simple_Toggle_Control extends Pubnews_WP_Base_Control {
        // control type
        public $type = 'simple-toggle';
    }

    // block repeater control 
    class Pubnews_WP_Block_Repeater_Control extends Pubnews_WP_Base_Control {
        // control type
    ...
    class Pubnews_WP_Item_Sortable_Control extends Pubnews_WP_Base_Control {
        // control type
    ...
    // typography control 
    class Pubnews_WP_Typography_Control extends Pubnews_WP_Base_Control {
        // control type
    ...
    // box shadow control 
    class Pubnews_WP_Box_Shadow_Control extends Pubnews_WP_Base_Control {
        // control type
        public $type = 'box-shadow';
    }

    // color group picker control - renders color and hover color control
    class Pubnews_WP_Color_Group_Picker_Control extends Pubnews_WP_Base_Control {
        // control type
        public $type = 'color-group-picker';
    }

    // Color group picker control - renders color and hover color control
    class Pubnews_WP_Background_Color_Group_Picker_Control extends Pubnews_WP_Base_Control {
        // control type
        public $type = 'background-color-group-picker';
    }

    // border control - renders border property control
    class Pubnews_WP_Border_Control extends Pubnews_WP_Base_Control {
        // control type
        public $type = 'border';
    }

    // section tab control - renders section tab control
    class Pubnews_WP_Section_Tab_Control extends Pubnews_WP_Base_Control {
        // control type
    ...
    // radio tab control
    class Pubnews_WP_Radio_Tab_Control extends Pubnews_WP_Base_Control {
        // control type
    ...
    // radio tab control
    class Pubnews_WP_Responsive_Multiselect_Tab_Control extends Pubnews_WP_Base_Control {
        // control type
    ...
    // tab group control
    class Pubnews_WP_Default_Color_Control extends WP_Customize_Color_Control {
        /**
    ...
    // info box control
    class Pubnews_WP_Info_Box_Control extends Pubnews_WP_Base_Control {
        // control type
    ...
    // preset control
    class Pubnews_WP_Preset_Colors_Control extends Pubnews_WP_Base_Control {
        public $type = 'preset-colors';
        public $blend = 'solid';
        public $variable = '--pubnews-global-preset-color-';
        ...
        public function to_json() {
            ...
            $this->variable = ( ( $this->blend === 'solid' ) ? $this->variable : '--pubnews-global-preset-gradient-color-' );
            $this->json['variable'] = $this->variable;
        }
    }

    // multiselect control
    class Pubnews_WP_Async_Multiselect_Control extends Pubnews_WP_Base_control {
        // control type
    ...
    // multiselect control
    class pubnews_WP_Multiselect_Control extends pubnews_WP_Base_control {
        // control type
    ...
    $wp_customize->register_control_type( 'Pubnews_WP_Radio_Image_Control' );
    $wp_customize->register_control_type( 'Pubnews_WP_Editor_Control' );
    ...
    $wp_customize->add_control( 
        new Pubnews_WP_Section_Heading_Control( $wp_customize, 'theme_color_header', array(
            'label'	      => esc_html__( 'Theme Color', 'pubnews' ),
            'section'     => 'colors',
    ...
    $wp_customize->add_setting( 'theme_color', array(
        'default'   => PND\pubnews_get_customizer_default( 'theme_color' ),
        'sanitize_callback' => 'pubnews_sanitize_color_picker_control',
        'transport' => 'postMessage'
    ));
    $wp_customize->add_control( 
        new Pubnews_WP_Preset_Color_Picker_Control( $wp_customize, 'theme_color', array(
            'label'	      => esc_html__( 'Theme Color', 'pubnews' ),
            'section'     => 'colors',
    ...
    $wp_customize->add_setting( 'site_background_color', array(
        'default'   => PND\pubnews_get_customizer_default( 'site_background_color' ),
        'transport' => 'postMessage',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control( 
        new Pubnews_WP_Color_Group_Control( $wp_customize, 'site_background_color', array(
    ...
    $wp_customize->add_setting( 'site_background_animation_heading', array(
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control( 
        new Pubnews_WP_Section_Heading_Control( $wp_customize, 'site_background_animation_heading', array(
            'label'	      => esc_html__( 'Animation Settings', 'pubnews' ),
            'section'     => 'background_image',
            'settings'    => 'site_background_animation_heading'
        ))
    );

    // site background color
    $wp_customize->add_setting( 'site_background_animation', array(
        'default'   => PND\pubnews_get_customizer_default( 'site_background_animation' ),
        'transport' => 'postMessage',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control( 'site_background_animation', array(
		'label'	      => esc_html__( 'Background animation', 'pubnews' ),
		'section'     => 'background_image',
		'settings'    => 'site_background_animation',
		'type'	=>	'select',
		'choices'	=>	[
			'none'	=>	esc_html__( 'None', 'pubnews' ),
			'three'	=>	esc_html__( 'Animation 1', 'pubnews' )
		],
		'priority'  => 20
	));
	...
	$wp_customize->add_setting( 'animation_object_color', [
		'default'   => PND\pubnews_get_customizer_default( 'animation_object_color' ),
		'transport' => 'postMessage',
		'sanitize_callback' => 'pubnews_sanitize_color_picker_control'
	]);
	$wp_customize->add_control( 
		new Pubnews_WP_Color_Picker_Control( $wp_customize, 'animation_object_color', [
			'label'	      => esc_html__( 'Animation object color', 'pubnews' ),
			'section'     => 'background_image',
...
add_action( 'customize_register', 'pubnews_customize_register' );

add_filter( PUBNEWS_PREFIX . 'unique_identifier', function($identifier) {
    $n_delimeter = '-';
    $n_prefix = 'customize';
    $n_sufix = 'control';
...
if( ! function_exists( 'pubnews_customizer_orderby_options_array' ) ) :
    /**
     * Array of order by control choices
     * 
     * @since 1.0.0
     */
    function pubnews_customizer_orderby_options_array() {
        return apply_filters( 'pubnews_customizer_orderby_options_array', [
			'date-desc' =>  esc_html__( 'Newest - Oldest', 'pubnews' ),
			'date-asc' =>  esc_html__( 'Oldest - Newest', 'pubnews' ),
			'title-asc' =>  esc_html__( 'A - Z', 'pubnews' ),
			'title-desc' =>  esc_html__( 'Z - A', 'pubnews' ),
			'rand-desc' =>  esc_html__( 'Random', 'pubnews' )
		]);
    }
endif;

if( ! function_exists( 'pubnews_get_all_fontawesome_icons' ) ) :
	/**
	 ...
	 * 
	 */
	function pubnews_get_all_fontawesome_icons( $type = '' ) {
        $fontawesome_icons = [
...
require get_template_directory() . '/inc/customizer/customizer-up.php'; // customizer upsell handlers
